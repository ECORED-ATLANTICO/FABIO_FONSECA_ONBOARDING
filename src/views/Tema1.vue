<template lang="pug">
  .curso-main-container.pb-3
    BannerInterno
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5.rounded-bottom-0
      ...
      .row
        ...
        .col-lg-5
          figure
            img(src='@/assets/curso/temas/1.png', alt='conservas de alimentos')
      ...
      .row.justify-content-center.my-3.bg-1-1-3.p-3.px-md-5.py-md-4.rounded-5.mb-3.mb-lg-5
        ...
        .col-lg-8.mb-3.mb-lg-0
          SlyderF(columnas="col-lg-6")
            .tarjeta.p-4.bg-white.rounded-2
              ...
              h2.text-center Método de conservación
              p.text-center estos deben garantizar que los alimentos están libres de microorganismos, es decir, que se debe garantizar la preservación de la salud del consumidor.

            .tarjeta.p-4.bg-white.rounded-2
              .row.justify-content-center.mb-3
                .col-4
                  img(src='@/assets/curso/temas/carousel-2.svg' alt='AvatarTop')
              h2.text-center Calidad sensorial
              p.text-center la calidad sensorial debe ser agradable a los sentidos de los consumidores. 


            .tarjeta.p-4.bg-white.rounded-2
              .row.justify-content-center.mb-3
                .col-4
                  img(src='@/assets/curso/temas/carousel-3.svg' alt='AvatarTop')
              h2.text-center Calidad de los envases:
              p.text-center estos deben estar en perfectas condiciones antes y después de preparar las conservas, es decir que no deben presentar daños físicos como abolladuras, fisuras o tapas infladas.

            .tarjeta.p-4.bg-white.rounded-2
              .row.justify-content-center.mb-3
                .col-4
                  img(src='@/assets/curso/temas/carousel-4.svg' alt='AvatarTop')
              h2.text-center Calidad de las materias primas
              p.text-center estas no deben presentar ninguna alteración en sus características fisicoquímicas y todas las condiciones sensoriales deben ser óptimas.

            .tarjeta.p-4.bg-white.rounded-2
              .row.justify-content-center.mb-3
                .col-4
                  img(src='@/assets/curso/temas/carousel-5.svg' alt='AvatarTop')
      ...
      .row.justify-content-center.mb-3.mb-lg-4
        ...
        .row.justify-content-center.mb-4.mb-lg-3
          .col-md-10
            h4.text-center.color-primario
              span.intersesion-title.rounded-3 Los factores que determinan el tiempo de escaldado son los siguientes:
              
      .row.justify-content-center.mb-3.mb-lg-4.bg-1-1-4
        .col-md-6.col-lg-3.align-content-center.mb-3.mb-lg-0
          .tarjeta.tarjeta--slyder.p-4.mb-0.tarjeta--factores(data-aos="zoom-in")
            img.my-3(src='@/assets/curso/temas/tema-1/frutas.svg', alt='Imagen decorativa')(style="width: 100px; justify-self: center")
            h4.text-center Variedad de la fruta
        .col-md-6.col-lg-3.align-content-center.mb-3.mb-lg-0
          .tarjeta.tarjeta--slyder.p-4.mb-0.h-100.tarjeta--factores(data-aos="zoom-in")
            img.my-3(src='@/assets/curso/temas/tema-1/metro.svg', alt='Imagen decorativa')(style="width: 100px; justify-self: center")
            h4.text-center Tamaño
        .col-md-6.col-lg-3.align-content-center.mb-3.mb-lg-0
          .tarjeta.tarjeta--slyder.p-4.mb-0.tarjeta--factores(data-aos="zoom-in")
            img.my-3(src='@/assets/curso/temas/tema-1/termometro.svg', alt='Imagen decorativa')(style="width: 100px; justify-self: center")
            h4.text-center Temperatura del escaldado
        .col-md-6.col-lg-3.align-content-center.mb-3.mb-lg-0
          .tarjeta.tarjeta--slyder.p-4.mb-0.tarjeta--factores(data-aos="zoom-in")
            img.my-3(src='@/assets/curso/temas/tema-1/fogata.svg', alt='Imagen decorativa')(style="width: 100px; justify-self: center")
